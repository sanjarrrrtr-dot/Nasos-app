...
// =====================================================================
const EU_TLDS = ['eu', 'de', 'fr', 'nl', 'be', 'at', 'ch', 'se', 'no', 'dk', 'pl', 'cz', 'sk', 'hu', 'ro', 'bg', 'hr', 'si', 'lt', 'lv', 'ee', 'pt', 'es', 'it', 'gr', 'ie', 'uk', 'fi', 'is'];
const TLD_REGION_PATTERNS = [
  ...
  [/\.cn$/i, 'CN'],
  [/\.tj$/i, 'TJ'],
  ...EU_TLDS.map((tld) => [new RegExp(`\\.${tld}$`, 'i'), 'EU']),
];
export function guessRegionFromDomain(hostname) {
