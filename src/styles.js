...
export const styles = {
  ...
  brandName: { fontFamily: '"IBM Plex Mono", monospace', fontWeight: 700, fontSize: 15, letterSpacing: '0.06em' },
  ...
  statCard: {
    background: COLORS.paper, border: `1px solid ${COLORS.line}`, borderRadius: 3, padding: '14px 12px',
    textAlign: 'center',
  },
  statValue: { fontFamily: '"IBM Plex Mono", monospace', fontSize: 24, fontWeight: 700 },
  statLabel: { fontSize: 11, color: COLORS.inkSoft, textTransform: 'uppercase', letterSpacing: '0.04em', marginTop: 2 },
  ...
  emptyState: {
    background: COLORS.paper, border: `1px dashed ${COLORS.line}`, borderRadius: 3, padding: 32,
  ...
  detailLabel: { fontSize: 10.5, textTransform: 'uppercase', letterSpacing: '0.05em', color: COLORS.brassDark, fontFamily: '"IBM Plex Mono", monospace' },
  ...
  primaryBtnSm: {
    ...
    color: '#fff', background: COLORS.steel, border: 'none', borderRadius: 2, padding: '9px 16px', cursor: 'pointer',
  },
  ghostBtnSm: {
  ...
  calcBreakdown: {
    background: COLORS.paper, border: `1px dashed ${COLORS.line}`, borderRadius: 2, padding: 10,
  ...
  calcRowTotal: {
    ...
    fontFamily: '"IBM Plex Mono", monospace', borderTop: `1px solid ${COLORS.line}`, paddingTop: 6, marginTop: 2,
  },
  calcRowEarn: {
  ...
  productIndex: { fontFamily: '"IBM Plex Mono", monospace', fontSize: 12, color: COLORS.inkSoft, minWidth: 20 },
  ...
  productLink: { fontSize: 12, color: COLORS.steel, wordBreak: 'break-all', display: 'block', marginTop: 3 },
  domainWarning: {
    fontSize: 11.5, color: '#b5433a', marginTop: 5, fontStyle: 'italic',
  },
  ...
  modalClose: {
    background: 'transparent', border: 'none', fontSize: 22, cursor: 'pointer', color: COLORS.inkSoft, lineHeight: 1,
  },
